        ...
        <div class="tab-content" id="manajemenTabContent">
            ...
            <div class="tab-pane fade" id="laporan-tab-pane" role="tabpanel">
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 py-3">
                    ...
                    <div class="col"><a href="<?= base_url('/neraca') ?>" class="text-decoration-none"><div class="card h-100 text-center management-card"><div class="card-body"><div class="icon-wrapper bg-success-subtle text-success"><i class="bi bi-balance-scale"></i></div><h5 class="card-title mt-3">Neraca Keuangan</h5><p class="card-text small text-muted">Lihat posisi aset, liabilitas, dan ekuitas keuangan RT.</p></div></div></a></div>
                    <?php if ($role === 'admin'): ?>
